...
# [REVERT 2026-09-14, C4] J6 ±360 -> ±225 (실기 원본). 09-08 확장은 트레이 이송을 통과시키려고 창을 넓힌 것이었다.
# cuRobo URDF(±360)와 맞추는 통일안은 오프라인 A/B 에서 회복 효과가 없어 cuRobo 는 그대로 둔다
# (docs/e0509_spec_audit.md §7). 세 곳의 J6 설정 불일치는 실기 노드 기록 사항.
