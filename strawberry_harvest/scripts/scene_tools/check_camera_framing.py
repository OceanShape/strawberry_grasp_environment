...
#: 화면 위 UI 영역 (비율). HUD 패널 좌상단(범례 줄까지), 손목 카메라 창 좌하단 (isaac_sim_viewport_display.py 의 크기 기준)
#: [2026-09-17] HUD 아래 끝 0.43 -> 0.49: '타겟 N / 비대상 M' 행과 결과 바·범례가 늘어 패널 아래 끝이 1080 기준 약 516~528px.
#: [2026-09-19] 0.49 -> 0.54: 결과 바 위 줄('수확 시작 전/진행 중/중단/완료')이 런 내내 보여 패널 아래 끝이 약 578px(완주 뒤에도 — 2단 트리 높이 유지).
UI = {"HUD": (0.0, 0.24, 0.0, 0.54), "PiP": (0.0, 0.27, 0.60, 1.0)}
