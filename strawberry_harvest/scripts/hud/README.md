...
**패널 높이 (2026-09-17)**: 두 행이 늘어 패널 아래 끝이 1080 기준 약 516\~528px(스텁 레이아웃 추정). 좌하단 그리퍼 카메라 창과는 뷰포트 높이 1000px 에서 40px 이상 떨어지고,
약 956px 보다 낮은 뷰포트에서는 범례 줄이 카메라 창에 가린다 — 녹화 레이아웃에서 확인한다.
