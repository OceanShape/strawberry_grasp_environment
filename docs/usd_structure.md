...
- `whiteboard.usd`의 `highlight/` 는 **활성 칸 하이라이트 오버레이**입니다 — 분면 4장 + 세부 칸 16장(09-12).
  2026-09-16 부터 **하늘색 발광 테두리**(그 전엔 격자 텍스처에 살구 tint 를 곱한 면 채우기): 분면 띠는 격자선과 같은 20mm 로
